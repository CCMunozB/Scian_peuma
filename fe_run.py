...
from fe_utils import generar_features_new, generar_sef_new
import time
...
if __name__ == "__main__":
    ...
    start = time.time()
    aux_df2 = generar_features_new(aux_path, overlap = 0.9, window_size_seg=10, peuma1=False, edf=True, aux_save_path=save_path)
